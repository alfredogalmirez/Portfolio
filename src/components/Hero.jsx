...
const Hero = () => {
  return (
    <section>
      <div className='font-lexend min-h-screen flex flex-col justify-center items-center space-y-4 bg-slate-100 dark:bg-neutral-900 py-8 px-8'>
        <img src={Profile} alt="Profile Photo" className='w-100 h-100 object-cover rounded-full items-center space-y-6 bg-slate-100 dark:bg-neutral-900 py-8 px-8' />
